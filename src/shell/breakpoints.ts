 ...
 *
 * React Native has no CSS `@media`, so responsiveness is decided in JS from the
 * viewport width. This module holds the pure decision; {@link useDesktopShell} is a
 * thin, SSR-safe wrapper around it.
 *
 * Thresholds follow the web design handoff: the large-screen shell targets
 * tablet-landscape and laptops, and the 372px timeline rail only appears once there
 * is room for it.
 */
