...
// this group at all: it is a root Stack route pushed from Home. AppTabBar still
// returns null for any route without a meta entry, so an unlisted one is skipped.
